package ru.professioonal.lesson4.task2;
...
public class Main {
    public static void main(String[] args) {
        Mouse jerryMouse = new Mouse("Jerry", 12, 5);
        Mouse nibblesMouse = new Mouse("Nibbles", 6, 2);
        Cat butchCat = new Cat("Butch", 15, 10);
        Cat tomCat = new Cat("Tom", 17, 9);
        Dog spikeDog = new Dog("Spike", 50, 1);
    }
}